...
export interface ErisEvents {
    ...
    guildMemberUpdate: (guild: Eris.Guild, member: Eris.Member, oldMember: {
        nick?: string;
        premiumSince: number;
        roles: string[];
    } | null) => void;
    ...
    messageReactionAdd: (message: Eris.PossiblyUncachedMessage, emoji: Eris.Emoji, reactor: Eris.Member | {
        id: string;
    }) => void;
    messageReactionRemove: (message: Eris.PossiblyUncachedMessage, emoji: Eris.PartialEmoji, userID: string) => void;
    ...
    relationshipUpdate: (relationship: Eris.Relationship, oldRelationship: {
        type: number;
    }) => void;
    typingStart: (channel: Eris.TextableChannel | {
        id: string;
    }, user: Eris.User | {
        id: string;
    }, member: Eris.Member | null) => void;
    ...
    voiceChannelSwitch: (member: Eris.Member, newChannel: Eris.VoiceChannel, oldChannel: Eris.VoiceChannel) => void;
